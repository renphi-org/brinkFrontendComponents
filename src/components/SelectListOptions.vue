...
const { addItemButtonLabel = 'Add Item', options } = defineProps<{ addItemButtonLabel?: string, multiple?: boolean, options: MaybeRef<SelectOption[]>, showAddItemButton?: boolean }>()
